...
<div id="modalEdicion" class="modal">
    <div class="modal-content">
        ...
        <h3>Paso 1: Crear conexión a la base de datos</h3>
        <pre>
&lt;?php
...
&lt;/table&gt;
        ...
        <h3>Paso 3: Crear producto (Crear)</h3>
        <!-- Resto de los pasos aquí en formato similar -->

        <h3>Paso 4: Editar producto (Actualizar)</h3>
        <h3>Paso 5: Eliminar producto (Borrar)</h3>
    </div>
</div>
